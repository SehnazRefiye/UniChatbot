# -*- coding: utf-8 -*-
"""
Created on Fri Nov 12 12:00:00 2021

@author: Şehnaz Yıldırım
"""

# Tester
fileObject = open("BusQuestionAnswer.csv", "r")
...
with open('BusQuestionAnswer.txt') as csv_file:
    ...
    for row in csv_reader:
        ...
        if line_count == 0:
            ...
            answer = chatBot.chatbot_question(row[1])
